    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center'>
          <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] text-[42px] text-white ss:leading-[100px] leading-[75px]'>
        ...
        <h1 className=' font-poppins font-semibold ss:text-[58px] text-[42px] text-white ss:leading-[100px] leading-[75px] w-full'>Payment Method.</h1>
...
We examine annual percentage rates, annual fees.</p>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className='absolute w-[80%] h-[80%] bottom-40 z-[1] white__gradient'/>
